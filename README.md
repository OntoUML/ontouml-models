# OntoUML/UFO Model Catalog for Ontology-Driven Conceptual Modeling Research
...
2. metadata.ttl: provides in a triple-based format all the catalog's metadata, and which aggregates all metadata from its composing ontologies;
...
5. metadata.ttl: is a rdf-based version in turtle syntax of metadata.yaml; 
...
***The OntoUML/UFO Catalog Administration team greatly appreciates you contribution to this project!***
...
If you know a UFO or OntoUML to be included into the catalog, please share this information with us! This can be done by send an email to any of the catalog's corresponding CORE members listed in this document's section [OntoUML/UFO Catalog's Administration](#ontoumlufo-catalogs-administration).

We provide a [List of UFO and OntoUML Ontology Models](https://docs.google.com/spreadsheets/d/1JXEA3k58yAkV_jbmEc7HP9QK7RgZC5Jk1y8MR7ylFyQ/edit?usp=sharinghttps://docs.google.com/spreadsheets/d/1JXEA3k58yAkV_jbmEc7HP9QK7RgZC5Jk1y8MR7ylFyQ/edit?usp=sharing) (read-only) that registers models to be further included into the catalog. The information received from collaborators are going to included in this list.

<!---> The list of OntoUML models no more is going to be editable for all public. It is going to be managed by the administration team and avaiable for the general users in read-only format.  <--->

### Contribute by reporting an application

If you wish to contribute to this initiative by **creating and reporting of an application** for the catalog, please send an email to any of the catalog's corresponding CORE members listed in this document's section [OntoUML/UFO Catalog's Administration](#ontoumlufo-catalogs-administration) for the update of this page with the tool's information and access link.

### Other ways to contribute

If you find any problems on the repository or have improvent ideas, please let us know by [creating an issue](https://github.com/unibz-core/ontouml-models/issues).

## Related Software Applications

Up to this moment we have no reported applications for quering, data manipulation or evaluation. If you wanto to contribute, please refer to this document's section ["Contributing by reporting an application"](#contributing-by-reporting-an-application).
...
For citing the OntoUML/UFO Catalog, please mention its GitHub repository's PURL: <https://purl.org/ontouml-models/git>.
 ...
 <!--- This section if going to be updated in case of a related paper's approval  --->

## Acknowledgements

We would like to specially thank:

- professor Giancarlo Guizzardi for the mentorship;
- Isadora Valle Sousa, Elena Romanenko, and Joshua Kritz for their contribution with the catalog's documentation and with data input and update;
...
Altought the OntoUML/UFO Catalog is an open project with a permissive license, a special attention must be given to the following licensing clauses:
